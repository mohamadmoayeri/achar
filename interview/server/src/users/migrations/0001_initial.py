    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_number', models.SlugField(max_length=11, unique=True, verbose_name='Mobile_number')),
                ('mobile_is_verified', models.BooleanField(default=False, verbose_name='Mobile_is_verified')),
